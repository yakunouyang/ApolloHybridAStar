...
bool ReedShepp::ShortestRSP(const std::shared_ptr<Node3d> start_node,
  ...
  if(optimal_path_index < 0) {
    return false;
  }

//  if(all_possible_paths[optimal_path_index].total_length > 10000.0) {
//    // filter out incorrect RSP
//    return false;
//  }
...
bool ReedShepp::GenerateRSPs(const std::shared_ptr<Node3d> start_node,
                             const std::shared_ptr<Node3d> end_node,
                             std::vector<ReedSheppPath>* all_possible_paths) {
  if (enable_parallel_hybrid_a_) {
    // AINFO << "parallel hybrid a*";
    if (!GenerateRSPPar(start_node, end_node, all_possible_paths)) {
      // PLOG_DEBUG << "Fail to generate general profile of different RSPs";
      return false;
    }
  } else {
    if (!GenerateRSP(start_node, end_node, all_possible_paths)) {
//      PLOG_ERROR << "Fail to generate general profile of different RSPs";
      return false;
    }
  }
  return true;
...
bool ReedShepp::SCS(const double x, const double y, const double phi,
  ...
  if (SLS_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with SLS_param";
    return false;
  }
  ...
  if (SRS_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with SRS_param";
    return false;
  }
  return true;
}
...
bool ReedShepp::CSC(const double x, const double y, const double phi,
  ...
  if (LSL1_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LSL_param";
    return false;
  }
  ...
  if (LSL2_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LSL2_param";
    return false;
  }
  ...
  if (LSL3_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LSL3_param";
    return false;
  }
  ...
  if (LSL4_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LSL4_param";
    return false;
  }
  ...
  if (LSR1_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LSR1_param";
    return false;
  }
  ...
  if (LSR2_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LSR2_param";
    return false;
  }
  ...
  if (LSR3_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LSR3_param";
    return false;
  }
  ...
  if (LSR4_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LSR4_param";
    return false;
  }
  return true;
}
...
bool ReedShepp::CCC(const double x, const double y, const double phi,
  ...
  if (LRL1_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRL_param";
    return false;
  }
  ...
  if (LRL2_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRL2_param";
    return false;
  }
  ...
  if (LRL3_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRL3_param";
    return false;
  }
  ...
  if (LRL4_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRL4_param";
    return false;
  }
  ...
  if (LRL5_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRL5_param";
    return false;
  }
  ...
  if (LRL6_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRL6_param";
    return false;
  }
  ...
  if (LRL7_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRL7_param";
    return false;
  }
  ...
  if (LRL8_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRL8_param";
    return false;
  }
  return true;
}
...
bool ReedShepp::CCCC(const double x, const double y, const double phi,
  ...
  if (LRLRn1_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRLRn_param";
    return false;
  }
  ...
  if (LRLRn2_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRLRn2_param";
    return false;
  }
  ...
  if (LRLRn3_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRLRn3_param";
    return false;
  }
  ...
  if (LRLRn4_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRLRn4_param";
    return false;
  }
  ...
  if (LRLRp1_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRLRp1_param";
    return false;
  }
  ...
  if (LRLRp2_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRLRp2_param";
    return false;
  }
  ...
  if (LRLRp3_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRLRp3_param";
    return false;
  }
  ...
  if (LRLRp4_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRLRp4_param";
    return false;
  }
  return true;
}
...
bool ReedShepp::CCSC(const double x, const double y, const double phi,
  ...
  if (LRSL1_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSL1_param";
    return false;
  }
  ...
  if (LRSL2_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSL2_param";
    return false;
  }
  ...
  if (LRSL3_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSL3_param";
    return false;
  }
  ...
  if (LRSL4_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSL4_param";
    return false;
  }
  ...
  if (LRSR1_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSR1_param";
    return false;
  }
  ...
  if (LRSR2_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSR2_param";
    return false;
  }
  ...
  if (LRSR3_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSR3_param";
    return false;
  }
  ...
  if (LRSR4_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSR4_param";
    return false;
  }
  ...
  if (LRSL6_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSL6_param";
    return false;
  }
  ...
  if (LRSL7_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSL7_param";
    return false;
  }
  ...
  if (LRSL8_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSL8_param";
    return false;
  }
  ...
  if (LRSR5_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSR5_param";
    return false;
  }
  ...
  if (LRSR6_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSR6_param";
    return false;
  }
  ...
  if (LRSR7_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSR7_param";
    return false;
  }
  ...
  if (LRSR8_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSR8_param";
    return false;
  }
  return true;
}
...
bool ReedShepp::CCSCC(const double x, const double y, const double phi,
  ...
  if (LRSLR1_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSLR1_param";
    return false;
  }
  ...
  if (LRSLR2_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSLR2_param";
    return false;
  }
  ...
  if (LRSLR3_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSLR3_param";
    return false;
  }
  ...
  if (LRSLR4_param.flag &&
    ...
    // PLOG_DEBUG << "Fail at SetRSP with LRSLR4_param";
    return false;
  }
  return true;
}
...
//    PLOG_ERROR << "total length smaller than 0";
    return false;
  }
...
//        PLOG_ERROR << "Fail at SetRSP, idx#: " << i;
        succ = false;
      }
    }
  }
  ...
  if (!succ) {
//    PLOG_ERROR << "RSP parallel fails";
    return false;
  }
  if (all_possible_paths->size() == 0) {
//    PLOG_ERROR << "No path generated by certain two configurations";
    return false;
  }
  return true;
}
